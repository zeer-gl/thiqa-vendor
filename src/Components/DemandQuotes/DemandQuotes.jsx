                  ...
                  <tr key={quote._id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end gap-2">
                        ...
                        {quote.isAccepted&&quote.acceptedByType=="vendor" ? (
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${selectedQuote.isAccepted&&selectedQuote.acceptedByType=="vendor" ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                    {selectedQuote.isAccepted&&selectedQuote.acceptedByType=="vendor" ? t('yes') : t('no')}
                  </span>
                </div>
              </div>
            ...
            <div className="mt-6 flex justify-end gap-4">
              ...
              {selectedQuote.isAccepted&&selectedQuote.acceptedByType=="vendor" ? (
